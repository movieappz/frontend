        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-[rgb(var(--text-secondary))] text-lg">
              Hallo {user.username}, hier ist dein Dashboard
            </p>
          </div>
            ...
            <div className="flex items-center gap-6 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[rgb(var(--text-secondary))]">
                  {favoriteCount} {favoriteCount === 1 ? 'Favorit' : 'Favoriten'}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <NavLink
              to="/favorites"
              className="group card p-6 hover:scale-105 transition-all duration-200"
            >
              <div className="flex items-center gap-4 mb-4">
              ...
              <p className="text-sm text-[rgb(var(--text-muted))]">
                {favoriteCount === 0 
                  ...
                  : "Verwalte deine Lieblingsfilme"
                }
              </p>
            </NavLink>

            {/* Filme entdecken Card */}
            <NavLink
              to="/"
              className="group card p-6 hover:scale-105 transition-all duration-200"
            >
              ...
              <p className="text-sm text-[rgb(var(--text-muted))]">
                Entdecke neue Filme und füge sie zu deinen Favoriten hinzu
              </p>
            </NavLink>
            ...
            <div className="card p-6">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span className="text-[rgb(var(--text-secondary))]">Favoriten:</span>
                  <span className="font-medium text-[rgb(var(--text-primary))]">{favoriteCount}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-[rgb(var(--text-secondary))]">Mitglied seit:</span>
                  <span className="font-medium text-[rgb(var(--text-primary))]">Heute</span>
                </div>
              </div>
            </div>
          </div>
